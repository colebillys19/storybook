...
import MDXDoc from 'components/MDX/docs/learnmdx.docs.mdx';

# Stories with MDX

You can now compose stories within your docs using the doc blocks addons `Meta`, `Preview`, `Props`, `Story` and MDX.
...
Creates one story in the canvas as well as a component in your markdown displayed on the docs tab.
...
<!--  --------------------- These are comments ---------------------------
  @description Preview Component
               ...
               - Allow you to preview code on the bottom right corner by clicking Show code.
  @typedef (component) Storybook addon-docs block
-->
...
Allow you to preview and copy code on the bottom right corner by clicking `Show code`.
